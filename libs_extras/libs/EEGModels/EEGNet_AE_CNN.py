...
#             nn.Softmax(dim=1)
        ...
        self.dconv3 = nn.Sequential( nn.ConvTranspose2d(in_channels=5, out_channels=4,  dilation=1, output_padding=0,  kernel_size=4,stride=2),   self.activation)
        self.dconv4 = nn.Sequential( nn.ConvTranspose2d(in_channels=4, out_channels=3,  dilation=1, output_padding=0,  kernel_size=3,stride=1),   self.activation)
